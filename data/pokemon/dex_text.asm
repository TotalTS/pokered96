...
_KangaskhanDexEntry::
	...
	page "protective belly"
	next "pouch until it is"
	next "3 years old"
	dex
...
_SlowbroDexEntry::
	...
	next "SLOWMO's tail is"

	page "said to feed on"
	next "the host's left"
	next "over scraps"
	dex
...
_PoliwrathDexEntry::
	...
	page "stroke. Easily"
	next "overtakes human"
	next "Olympic winners"
	dex
...
_GolduckDexEntry::
	...
	page "webbed front feet"
	next "enhance its strong"
	next "swimming ability"
	dex
...
_RaticateDexEntry::
	text "Uses its whiskers"
	next "to maintain its"
	next "balance."
