...
_CinnabarGymAfterBattleText5::
	text "Coleman was lost"
	line "in the mountains"
	cont "when a fiery bird"
	cont "#MON appeared."

	para "Its light enabled"
	line "Coleman to find"
	cont "his way down!"
	done
